<template>
    ...
    <div class="py-20">
        <Container class="grid xs:grid-cols-2 md:grid-cols-4 items-center justify-center gap-20">
            <div v-for="(company, index) in companiesList" :key="index" class="w-full">
                <NuxtImg :src="company" class="w-full"/>
            </div>
        </Container>
    </div>
</template>
